...
varia.set_emission(3)
print(varia.get_wavelength())
print(varia.get_emission())
print(varia.get_power())
varia.set_pulse_picker_ratio(2)
time.sleep(2)
print(varia.get_pulse_picker_ratio())
print(varia.get_current_level())
time.sleep(1)
print(registerWriteU16('COM7', 15, 0x32, 2, -1))
varia.set_emission(3)
time.sleep(1)
print(varia.get_interlock_status())
print(registerReadU8(varia.portname, varia.FIANIUM_ADDRESS, 0x36, -1),"watchdog")
print(registerReadU16(varia.portname, varia.FIANIUM_ADDRESS, 0x66, -1),"status")